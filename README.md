...
It produces the `reactive-pg-client-quickstart-1.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
You can then execute your native executable with: `./target/reactive-pg-client-quickstart-1.0-SNAPSHOT-runner`
